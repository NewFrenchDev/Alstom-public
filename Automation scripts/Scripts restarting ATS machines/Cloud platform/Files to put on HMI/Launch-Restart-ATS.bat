...
:: This launch the script Restart-ATS.bat on the network folder's root

if %COMPUTERNAME%==OCC_LCM_TCC1 goto Get_credentials
if %COMPUTERNAME%==OCC_LCM_TCC2 (goto Get_credentials) else goto Stop_script
