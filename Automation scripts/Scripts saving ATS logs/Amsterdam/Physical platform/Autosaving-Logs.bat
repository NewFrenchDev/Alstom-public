...
::Folder to stock files from Playback folder (for taking only the day)
...
set Zip_folder=D:\Playback_%date%.%zip_ext%
...
"C:\Program Files\7-Zip\7z.exe" a -mx7 "%Zip_folder%" "%Temp_playback%"
